...
public final class UsersWithoutEmailQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query UsersWithoutEmail {
      users {
        __typename
        name
        posts {
  ...
  public let operationName: String = "UsersWithoutEmail"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public init(name: String, posts: [Post]? = nil) {
        self.init(unsafeResultMap: ["__typename": "User", "name": name, "posts": posts.flatMap { (value: [Post]) -> [ResultMap] in value.map { (value: Post) -> ResultMap in value.resultMap } }])
      }
